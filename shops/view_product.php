...
function product_delete(val)
    {
     var r = confirm("Confirm to Delete order....!");
      if (r == true) {
        txt = "You pressed OK!";
      window.location.href="product_delete.php?id="+val;
            ...
            <div class="card-body table table-responsive">
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style='width:10px'>
                    <a href='product_update.php?id=".$pr[0]."'>
                      <button type='button' class='btn btn-block btn-outline-info btn-flat btn-xs'>Update</button>
                    </a>
                  </td>
                  <td style='width:10px'>
                      <button type='button' class='btn btn-block btn-outline-danger btn-flat btn-xs'onclick='product_delete($pr[0])'>Delete</button>
